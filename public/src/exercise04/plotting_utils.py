...
def plot_recorded_states(
    data, state_names=_state_names, title="Drone Positions", freq=50, figsize=(10, 6), axis=None
):
...
def plot_regression_results(
    X, y, model_predictions, model_std=None, title="Regression Results", figsize=(8, 5), axis=None
):
...
def plot_random_test_point(
    ...
    if axis is None:
        ...
        ax = axis
    ax.scatter(
        y_test[idx, state_1_idx],
        y_test[idx, state_2_idx],
        s=80,
        color="green",
        edgecolor="black",
        label="Ground Truth",
...
def plot_2d_positions_with_std(
    ...
    if x_lim is not None:
        ...
        if y_train is not None:
            train_mask &= (y_train[:, state_1_idx] >= x_lim[0]) & (
    ...
    if y_lim is not None:
        ...
        if y_train is not None:
            train_mask &= (y_train[:, state_2_idx] >= y_lim[0]) & (
...
def plot_error_distribution(
    y_test, y_pred, state_names=_state_names, model_name="GP", figsize=(10, 5), axis=None
):
