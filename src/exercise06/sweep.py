...
assert False, (
    "This script is currently not being used. It provides a template for conducting wandb sweeps. The usage of ppo.PPOTrainer needs to be checked before using this script. Also requires `pip install fire`"
)
